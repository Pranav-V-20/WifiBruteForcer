...
echo.                              !_yellow!Developed by !_Cyan!Pranav V
echo !_yellow! [---------------------------------------------------------------------------]
echo. !_Default!
goto :eof
...
echo.
echo Wi-Fi Brute Forcer Result>>"!_PASSWORD_FOUND_FILE!"
...
echo  ------------------------------------------------------------------------------
echo  Credits:
echo  ^> !_Yellow!Pranav V		- !_white!Developer.
...
echo  More projects : !_Blue!https://github.com/Pranav-V-20!_Default!
echo. 
